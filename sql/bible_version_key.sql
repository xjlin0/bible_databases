...
INSERT INTO `bible_version_key` VALUES (001,'t_asv','ASV','english','American Standard-ASV1901','','http://en.wikipedia.org/wiki/American_Standard_Version','','Public Domain',''),(002,'t_bbe','BBE','english','Bible in Basic English','','http://en.wikipedia.org/wiki/Bible_in_Basic_English','','Public Domain',''),(004,'t_kjv','KJV','english','King James Version','','http://en.wikipedia.org/wiki/King_James_Version','','Public Domain',''),(006,'t_web','WEB','english','World English Bible','','http://en.wikipedia.org/wiki/World_English_Bible','','Public Domain',''),(007,'t_ylt','YLT','english','Young\'s Literal Translation','','http://en.wikipedia.org/wiki/Young%27s_Literal_Translation','','Public Domain',''),(008, 't_cunpts', 'CUVNPTS', 'chinese, traditional', 'Chinese Union Version with New Punctuation in Traditional Chinese, Shen Edition', '', 'https://en.wikipedia.org/wiki/Chinese_Union_Version', '', 'Public Domain', '');
...
-- Dump completed on 2020-08-24 18:19:17
